...
### Added
- Next.js 15 frontend (Vault) with Tailwind CSS + shadcn/ui
- Dashboard with account balances (UAH, USD)
- Deposit, Withdraw, Transfer operations
- Transaction history per account
- Notification history
- Profile — change email
- BFF pattern via Next.js Route Handlers
- Dark charcoal theme (#0f1117)
